...
files. Then we run our while loop to unzip all of the `.zip` files in this directory.
...
our scripts. Go ahead and select `A` each time this message appears. It will appear once per sample file (four times total).
