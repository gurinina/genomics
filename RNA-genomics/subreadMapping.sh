...
samtools view -h ERR458493.bam | grep -e "(NH:i:1|^@)" | 
# aligning
...
# Multi-mapping reads
  ...
  #                     multi-mapping reads. If a gene annotations file is used during the map/align stage, and the splice junction is detected as an annotated junction, then 20 is added to its motif value.
