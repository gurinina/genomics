...
Here before we start we want to make a folder r64 in the RNA-genomic directory. Now we'll run the alignment:
```{r eval=FALSE}
...
OK, let's start this and go back to our shell script.
```{r eval=FALSE}

Rsubread::align(index = "r64/r64.index", readfile1 = fastq.files,
output_file = bam.files,useAnnotation=TRUE,annot.ext = "FASTQ/r64/Saccharomyces_cerevisiae.R64-1-1.96.gtf.gz",isGTF = TRUE,nthreads=64,sortReadsByCoordinates=TRUE, keepReadOrder=FALSE)
```
