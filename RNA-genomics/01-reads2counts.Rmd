...
<p align="center">
  <img width="800" src="figures/04-workflow-overview.png" >
</p>
...
These files take about 7' to download.
...
head -n 4 FASTQ/ERR458493.fastq
...
(I had a really hard time getting this to work by typing it into the terminal
with line breaks, so wait to run it in the shell script!)
```{zsh, eval=FALSE, engine="sh"}
...
subread-align --multiMapping -t0 --sortReadsByCoordinates -a\ 
r64/Saccharomyces_cerevisiae.R64-1-1.96.gtf.gz\ 
-B 3 -T 16 -i r64/r64bread.index\
-r ERR458493.fastq.gz\
-o ../BAM/ERR458493.bam &> ../BAM/R493.log
